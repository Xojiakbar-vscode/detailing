      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <a
              href="https://t.me/apex_detailing_demo" // Simulated bot or contact
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex items-center space-x-2 bg-gradient-to-r from-[#0070f3] to-[#00c2ff] hover:from-[#00c2ff] hover:to-[#0070f3] text-white text-xs font-semibold px-5 py-2.5 rounded-full shadow-[0_0_15px_rgba(0,112,243,0.3)] hover:shadow-[0_0_25px_rgba(0,194,255,0.5)] transition-all duration-300 transform hover:scale-[1.02] border border-white/10"
            >
          ...
          >
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-[#0070f3] to-[#00c2ff] text-white font-bold py-4 rounded-xl shadow-[0_0_15px_rgba(0,112,243,0.3)]"
              >
                <Send className="w-4 h-4" />
                <span>Book via Telegram</span>
              </a>
              <div className="text-center text-xs text-gray-500">
                Premium Auto Detailing • Tashkent, Uzbekistan
              </div>
            </motion.div>
          </motion.div>
        )}
